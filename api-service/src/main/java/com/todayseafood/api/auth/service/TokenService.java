...
import com.todayseafood.api.auth.entity.RefreshToken;
import com.todayseafood.api.auth.repository.RefreshTokenRepository;
import com.todayseafood.api.auth.service.decoder.Decoder;
import com.todayseafood.api.auth.service.encoder.Encoder;
import com.todayseafood.api.auth.service.encryption.Encrypt;
import com.todayseafood.api.auth.service.property.TokenProperty;
import com.todayseafood.api.security.exception.authentication.*;
import com.todayseafood.api.security.role.RoleConfig;
...
public class TokenService {
    ...
    private String issueAccessToken(long userId, RoleConfig roleConfig) {
        return issue(tokenProperty.getAccessTokenTtlMillis(), "ACCESS_TOKEN", userId, roleConfig);
    }

    private String issueRefreshToken(long userId, RoleConfig roleConfig) {
        return issue(tokenProperty.getRefreshTokenTtlMillis(), "REFRESH_TOKEN", userId, roleConfig);
    }
