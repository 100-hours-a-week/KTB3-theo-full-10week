package com.todayseafood.api.app.aop.aspect.log;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.todayseafood.api..service..*(..))")
    private void serviceLayer() {
    }

    @Pointcut("@annotation(com.todayseafood.api.app.aop.aspect.log.Loggable)")
